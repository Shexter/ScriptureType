...
export default defineConfig(({ mode }): UserConfig => {
  ...
  fetch("http://127.0.0.1:7245/ingest/fcd1d3c3-1c32-4bb8-80de-88b7684b37b7", {
    method: "POST",
    ...
    body: JSON.stringify({
      ...
      data: {
        mode,
        isDevelopment,
        hasRecaptcha: env["RECAPTCHA_SITE_KEY"] !== undefined,
        hasSentry: useSentry,
        hasSentryToken: env["SENTRY_AUTH_TOKEN"] !== undefined,
      },
      timestamp: Date.now(),
