...
import Config, { applyConfigFromJson } from "../config";
...
export async function getList(
  listName:
    | ListsObjectKeys
    | (keyof CommandlineConfigMetadataObject & string)
    | string,
...
function buildCommands(
  ...commands: (Command | (keyof CommandlineConfigMetadataObject & string))[]
): Command[] {
